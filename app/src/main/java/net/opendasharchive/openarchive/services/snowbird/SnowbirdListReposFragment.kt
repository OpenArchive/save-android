...
class SnowbirdListReposFragment : CommonServiceFragment(), SnowbirdGroupsAdapterListener {
...
//        }
    ...
    private fun createViewModel() {
        adapter = MockGroupAdapter {
            findNavController().navigate(SnowbirdListReposFragmentDirections.navigateToSnowbirdListDocumentsScreen())
        }
